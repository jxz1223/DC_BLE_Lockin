...
void SystemClock_Config(void)
{
  ...
  */
  ...
  HAL_RCC_MCOConfig(RCC_MCO3, RCC_MCO1SOURCE_SYSCLK, RCC_MCODIV_4);
}
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, LDAC_Pin|SDATA_Pin|SCLK_Pin|FSYNC_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, M3_Pin|M1_Pin|M2_Pin|M4_Pin
                          |ME_Pin|Blue_Led_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SDATA_Pin SCLK_Pin FSYNC_Pin */
  GPIO_InitStruct.Pin = SDATA_Pin|SCLK_Pin|FSYNC_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  ...
  /*Configure GPIO pins : M3_Pin M1_Pin M2_Pin M4_Pin */
  GPIO_InitStruct.Pin = M3_Pin|M1_Pin|M2_Pin|M4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : ME_Pin */
  GPIO_InitStruct.Pin = ME_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(ME_GPIO_Port, &GPIO_InitStruct);
