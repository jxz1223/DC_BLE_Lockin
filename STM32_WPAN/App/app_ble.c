...
float a_ConnInterval[SIZE_TAB_CONN_INT] = {100, 100}; /* Keep relay anchor if re-enabled. */
...
{
  13, AD_TYPE_MANUFACTURER_SPECIFIC_DATA, 0x01, 0x88, 0x00 /*  */, 0x00 /*  */, 0x00 /*  */, 0x00 /*  */, 0x00 /*  */, 0x00 /*  */, 0x00 /*  */, 0x00 /*  */, 0x00 /*  */, 0x00 /*  */,
};
...
static void LinkConfiguration(void)
{
  ...
  status = hci_le_set_data_length(BleApplicationContext.BleApplicationContext_legacy.connectionHandle,SizeTx_Char,2120);
